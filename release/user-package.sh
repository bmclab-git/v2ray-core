...
get_source() {
	...
	git clone https://github.com/bmclab-git/v2ray-core.git
	cd v2ray-core
	go mod download
}
...
build_v2() {
	...
	LDFLAGS="-s -w -buildid= -X github.com/bmclab-git/v2ray-core/v5.codename=${CODENAME} -X github.com/bmclab-git/v2ray-core/v5.build=${BUILDNAME} -X github.com/bmclab-git/v2ray-core/v5.version=${VERSIONTAG}"
